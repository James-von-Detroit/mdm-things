...
sudo -u $user /usr/bin/defaults write com.trusourcelabs.NoMAD GetHelpOptions -string "URL"
...
sudo -u $user /usr/bin/defaults write com.trusourcelabs.NoMAD LocalPasswordSyncDontSyncLocalUsers -array tm_admin
